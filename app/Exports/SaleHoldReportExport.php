...
use App\Http\Resources\SaleHoldReportDatatableResource;
...
class SaleHoldReportExport implements FromCollection, withMapping, WithHeadings, ShouldAutoSize, WithEvents {
    ...
    public function collection()
    {
        ...
        $saleDetails = SaleHoldReportDatatableResource::collection($saleDetails);
