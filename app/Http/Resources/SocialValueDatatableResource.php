...
class SocialValueDatatableResource extends JsonResource
{
    /**
    ...
    {
        $edit = '';
        if (hasPermission('social-values','write')) {
            $edit = "<a href='" . route('social-values.edit', base64_encode($this->id)) . "'
        ...
        $delete = '';
        if (hasPermission('social-values','delete')) {
            $delete = Form::open(['route' => ['social-values.destroy', base64_encode($this->id)], 'method' => 'delete', 'class' => 'd-inline'])
