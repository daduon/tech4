...
class PressDatatableResource extends JsonResource
{
    /**
    ...
    {
        $edit = '';
        if (hasPermission('press','write')) {
            $edit = "<a href='" . route('presses.edit', base64_encode($this->id)) . "'
        ...
        $delete = '';
        if (hasPermission('press','delete')) {
            $delete = Form::open(['route' => ['presses.destroy', base64_encode($this->id)], 'method' => 'delete', 'class' => 'd-inline'])
