    ...
    <div>
        <section class="section">
            ...
            <div class="section-body">
                {{ Form::open(['url' => route('blogs.store'),'class' => 'need-validation' ,'id'=>'create','files' => true ,'autocomplete' => 'off']) }}
                <div class="card">
                    <div class="row">
                        <div class="col-9">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="choose_option" name="choose_option" >
                                        <option value="1" {{ old('choose_option')===1?'selected':'' }} >Defaulf</option>
                                        <option value="2" {{ old('choose_option')===2?'selected':'' }} >Share Link</option>
                                    </select>
                                </div>
                                ...
                                <div class="form-row option_1">
                                    <div class="form-group col-md-12">
                                        ...
                                        <input name="share_link" value="{{ old('share_link') }}" type="url"
                                               class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="option_2">
                                    <div class="form-row">
                                        <div class="form-group col-md-12">
                                            <label for="description_en">Articles 2 <img class="img-flag" src="{{ url('images/flag/en.jpg') }}"></label>
                                            <textarea
                                                    class="form-control editor"
                                                    id="description_en"
                                                    name="description_en"
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-12">
                                            ...
                                            <textarea
                                                    ...
                                                    rows="5">{{old('key_description')}}</textarea>
                                        </div>
                                    </div>
                                    <div class="form-row">
                                        <div class="form-group col-md-12">
                                            <label for="reading_time">Reading Time</label>
                                            <input name="reading_time" id="reading_time" value="{{ old('reading_time') }}" type="number"
