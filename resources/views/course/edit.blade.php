    ...
    <div id="course">
        <section class="section">
            ...
            <div class="section-body">
                {{ Form::open(['url' => route('courses.update',base64_encode($course->id)),'class' => 'need-validation','method' => 'put' ,'files' => true ,'autocomplete' => 'off']) }}
                <div class="card">
                    <div class="row">
                        <div class="col-9">
                            <div class="card-body">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <select name="program" class="form-control select2" required>
                                            ...
                                            @foreach($programs as $program)
                                                <option
                                                    {{ $course->program_id == $program->id ? 'selected' : '' }} value="{{ base64_encode($program->id) }}">{{ $program->title_en }}</option>
                                            @endforeach
                                        </select>
                                        @error('program')
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input name="title_kh" value="{{ $course->title_kh }}" type="text"
                                               class="form-control">
                                    </div>
                                </div>
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        <label>SubTitle <img class="img-flag"
                                                ...
                                                class="note">*</span></label>
                                        <input name="subtitle_en" value="{{ $course->sub_title_en }}" type="text"
                                    ...
                                    <div class="form-group col-md-6">
                                        <label>SubTitle <img class="img-flag"
                                                             src="{{ url('images/flag/kh.jpg') }}"></label>
                                        <input name="subtitle_kh" value="{{ $course->sub_title_kh }}" type="text"
                                               class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-12">
                                        ...
                                        <input name="price" value="{{ $course->price }}" type="text"
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input name="start_date" data-current="{{ date('m/d/Y',strtotime($course->date_from)) }}" value="{{ date('m/d/Y',strtotime($course->date_from)) }}" type="text"
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input name="end_date" required data-current="{{ date('m/d/Y',strtotime($course->date_to)) }}" value="{{ date('m/d/Y',strtotime($course->date_to)) }}" type="text"
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="overview_en" required
                                              class="form-control editor">{{ $course->overview_en }}</textarea>
                                    @error('overview_en')
                                    <div class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="overview_kh"
                                              class="form-control editor">{{ $course->overview_kh }}</textarea>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="outline_en" required
                                              class="form-control editor">{{ $course->outline_en }}</textarea>
                                    @error('outline_en')
                                    <div class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="outline_kh"
                                              class="form-control editor">{{ $course->outline_kh }}</textarea>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="structure_en" required
                                              class="form-control editor">{{ $course->structure_en }}</textarea>
                                    @error('structure_en')
                                    <div class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="structure_kh"
                                              class="form-control editor">{{ $course->structure_kh }}</textarea>
                                </div>
                                ...
                                <table class="table table-bordered table-md">
                                    ...
                                    @if(old('include_en'))
                                        ...
                                        @endforeach
                                    @elseif(count($course->includes) > 0)
                                        @foreach($course->includes as $i => $include)
                                            <tr>
                                                <td>
                                                    <div class="input-group mb-3">
                                                        <input type="text" value="{{ $include->title_en }}"
                                                               class="form-control"
                                                               placeholder="Include EN"
                                                               name="include_en[]">
                                                    </div>
                                                ...
                                                <td>
                                                    <div class="input-group mb-3">
                                                        <input type="text" value="{{ $include->title_kh }}"
                                                               class="form-control"
                                                               placeholder="Include KH"
                                                               name="include_kh[]">
                                                        <div class="input-group-append">
                                                            <span class="btn {{ $i == 0 ? 'btn-primary btn-add-include' : 'btn-danger btn-remove' }}">{{ $i == 0 ? 'Add' : 'Remove' }}</span>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
                                ...
                                <table class="table table-bordered table-md">
                                    ...
                                    @if(old('requirement_en'))
                                        ...
                                        @endforeach
                                    @elseif(count($course->requirements) > 0)
                                        @foreach($course->requirements as $i => $requirement)
                                            <tr>
                                                <td>
                                                    <div class="input-group mb-3">
                                                        <input type="text" value="{{ $requirement->title_en }}"
                                                               class="form-control"
                                                               placeholder="Requirement EN"
                                                               name="requirement_en[]">
                                                    </div>
                                                ...
                                                <td>
                                                    <div class="input-group mb-3">
                                                        <input type="text" value="{{ $requirement->title_kh }}"
                                                               class="form-control"
                                                               placeholder="Requirement KH"
                                                               name="requirement_kh[]">
                                                        <div class="input-group-append">
                                                            <span class="btn {{ $i == 0 ? 'btn-primary btn-add-requirement' : 'btn-danger btn-remove' }}">{{ $i == 0 ? 'Add' : 'Remove' }}</span>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
                                ...
                                <table class="table table-bordered table-md">
                                    ...
                                    @if(old('benefit_en'))
                                        ...
                                        @endforeach
                                    @elseif(count($course->benefits) > 0)
                                        @foreach($course->benefits as $i => $benefit)
                                            <tr>
                                                <td>
                                                    <div class="input-group mb-3">
                                ...
                                <table class="table table-bordered table-md">
                                    ...
                                    @if(old('eligible_en'))
                                        ...
                                        @endforeach
                                    @elseif(count($course->eligibles) > 0)
                                        @foreach($course->eligibles as $i => $eligible)
                                            <tr>
                                                <td>
                                                    <div class="input-group mb-3">
                                ...
                                <table class="table table-bordered table-md">
                                    ...
                                    @if(old('process_en'))
                                        ...
                                        @endforeach
                                    @elseif(count($course->processes) > 0)
                                        @foreach($course->processes as $i => $process)
                                            <tr>
                                                <td>
                                                    <div class="input-group mb-3">
                                ...
                                <table class="table table-bordered table-md">
                                    ...
                                    @if(old('location_en'))
                                        ...
                                        @endforeach
                                    @elseif(count($course->locations) > 0)
                                        @foreach($course->locations as $i => $location)
                                            <tr class="location-text-{{ $i }}">
                                                <td>
                                                    <div class="input-group mb-3">
                                                        <input type="text" value="{{ $location->title_en }}"
                                                               class="form-control"
                                                               placeholder="Location EN"
                                                               name="location_en[]">
                                                    </div>
                                                ...
                                                <td>
                                                    <div class="input-group mb-3">
                                                        <input type="text" value="{{ $location->title_kh }}"
                                                               class="form-control"
                                                               placeholder="Location KH"
                                                               name="location_kh[]">
                                                        <div class="input-group-append">
                                                            <span data-index="{{ $i }}" class="btn {{ $i == 0 ? 'btn-primary btn-add-location' : 'btn-danger btn-remove-location' }}">{{ $i == 0 ? 'Add' : 'Remove' }}</span>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
                        ...
                        <div class="col-3">
                            <div class="card-body">
                                <div class="form-group text-center mb-1">
                                    ...
                                    <img class="img-fluid"
                                         src="{{ $course->icon_img ? url($course->icon_img) : url('images/default-image.png') }}"
                                         alt="Image">
                                ...
                                <div class="form-group text-center mb-1">
                                    ...
                                    <p class="note mb-1">(800px * 800px)</p>
                                    <img class="img-fluid"
                                         src="{{ $course->img ? url($course->img) : url('images/default-image.png') }}"
                                         alt="Image">
