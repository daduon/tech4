        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    <div class="breadcrumb-item"><a href="{{ route('blog-page.index') }}">Blog Page</a></div>
                </div>
            </div>
            <div class="section-body">
                {{ Form::open(['url' => route('blog-page.update',base64_encode($blogPage->id)),'id'=> 'form','method' => 'PUT' ,'files' => true ,'autocomplete' => 'off']) }}
                <div class="card">
                    <div class="card-header title border-bottom">
                        <h5 class="text-white">Blog Overview Content </h5>
                    </div>
                    <div class="card-body">
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <label>Title<span class="note">*</span> <img class="img-flag" src="{{ url('images/flag/en.jpg') }}"></label>
                                <input name="title_en" value="{{ $blogPage->title_en }}" type="text"
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input name="title_kh" value="{{ $blogPage->title_kh  }}" type="text"
                                       class="form-control">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-6">
                                ...
                                <textarea name="text_en" cols="30"
                                          ...
                                          id="text_en"
                                          rows="4">{{ $blogPage->text_en }}</textarea>
                                @error('text_en')
                                <div class="invalid-feedback d-block" role="alert">
                                    <strong>{{ $message }}</strong>
                                </div>
                            ...
                            <div class="form-group col-6">
                                ...
                                <textarea name="text_kh" cols="30" class="form-control"
                                          id="text_kh"
                                          rows="4">{{ $blogPage->text_kh }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
