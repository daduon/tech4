    ...
    <div>
        <section class="section">
            ...
            <div class="section-body">
                {{ Form::open(['url' => route('why-us.update',base64_encode($whyUs->id)),'id'=> 'form','method' => 'PUT' ,'files' => true ,'autocomplete' => 'off']) }}
                <div class="card">
                    <div class="row">
                        <div class="col-9">
                            <div class="card-body">
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input name="title_en" value="{{ $whyUs->title_en }}" type="text"
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input name="title_kh" value="{{ $whyUs->title_kh}}" type="text"
                                               class="form-control">
                                    </div>
                                </div>
                                <div class="form-row">
                                    <div class="form-group col-6">
                                        ...
                                        <textarea name="short_text_en" cols="30" class="form-control" id="short_text_en"
                                                  rows="4">{{ $whyUs->short_text_en }}</textarea>
                                    </div>
                                    <div class="form-group col-6">
                                        ...
                                        <textarea name="short_text_kh" cols="30" class="form-control" id="short_text_kh"
                                                  rows="4">{{ $whyUs->short_text_kh }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-3">
                            <div class="card-body">
                                <div class="form-group text-center mb-1">
                                    ...
                                    <img class="img-fluid"
                                         src="{{ $whyUs->img ? url($whyUs->img) : url('images/why-us/why-us.png') }}"
                                         alt="Image">
