    ...
    <div>
        <section class="section">
            ...
            <div class="section-body">
                {{ Form::open(['url' => route('mentors.update',base64_encode($mentors->id)),'id'=> 'form','class' => 'need-validation','method' => 'PUT' ,'files' => true ,'autocomplete' => 'off']) }}
                <div class="card">
                    <div class="row">
                        <div class="col-9">
                            <div class="card-body">
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input name="name_en" value="{{ $mentors->name_en }}" type="text"
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input name="name_kh" value="{{ $mentors->name_kh  }}" type="text"
                                               class="form-control">
                                    </div>
                                </div>
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input name="position_en" value="{{ $mentors->position_en  }}" type="text"
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input name="position_kh" value="{{ $mentors->position_kh }}" type="text"
                                               class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-6">
                                        ...
                                        <textarea name="text_en" cols="30"
                                                  ...
                                                  id="text_en"
                                                  rows="4" required>{{ $mentors->text_en  }}</textarea>
                                        @error('text_en')
                                        <div class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </div>
                                    ...
                                    <div class="form-group col-6">
                                        ...
                                        <textarea name="text_kh" cols="30" class="form-control" id="text_kh"
                                                  rows="4">{{ $mentors->text_kh  }}</textarea>
                                    </div>
                                </div>
                                <div class="form-row">
                                    <div class="form-group col-md-4">
                                        <label>Facebook Link(URL)</label>
                                        <input name="fb_url" value="{{ $mentors->fb_url }}" type="text"
                                               class="form-control">
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label>Instagram Link(URL)</label>
                                        <input name="ig_url" value="{{ $mentors->ig_url }}" type="text"
                                               class="form-control">
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label>Linkin Link(URL)</label>
                                        <input name="in_url" value="{{ $mentors->in_url }}" type="text"
                                               class="form-control">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-3">
                            <div class="card-body">
                                <div class="form-group text-center mb-1">
                                    ...
                                    <img class="img-fluid"
                                         src="{{ $mentors->img ? url($mentors->img) : url('images/default-image.png') }}"
                                         alt="Image">
